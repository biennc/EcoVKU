...
const GiveBottleReceiveGift = (props) => {
  ...
  const calculatePoints = () => {
    ...
    setAlertMessage(`Bạn nhận được ${totalPoints} điểm và 1 chậu sen đá nhỏ)`);
    setShowAlert(true);
  };
  ...
  return (
    <>
      <div className="icons">
        ...
        <p>
          Đi dạo trong thành phố và thiên nhiên và thu thập vật liệu có thể tái
          chế. Cho mọi thứ vào túi, chụp ảnh, tái chế và đổi sen đá.
        </p>
        <button
          onClick={handleShow}
          className="btn"
        ...
        <Modal.Body>
          ...
          <Form>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Select
                value={selectedTrash}
                onChange={handleTrashTypeChange}>
